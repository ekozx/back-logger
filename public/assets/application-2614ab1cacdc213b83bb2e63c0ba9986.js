...
(function() {
  $(function() {
    var addHandler, appendControllerData, appendEntryHTML, appendUserHTML, buildAttachedHTML, buildHandler, buildRequestHTML, buildUserHTML, followHandler, loaded, loading;
    $('#added').hide();
    loading = function() {
      $('.loading').show();
    ...
    buildUserHTML = function(amazonPath, user_id, name) {
      var add, html;
    ...
    appendEntryHTML = function(data) {
      ...
      html = "<li class='new_well '><a href='/entries/" + data['id'] + "'><img alt='Missing' src='" + photo + "' class='img-circle''>";
      html += "</a>" + title + "<a class='deleteEntry' id='deleteTmp" + data['id'] + "' data-method='delete' data-remote='true' href='/entries/";
    ...
    appendControllerData = function(data, type, list) {
      var add, addAnchor, amazonPath, html, k, max, picture, v, _results, _results1;
      loaded();
      max = 5;
      if (type === 'entries') {
        _results = [];
        ...
        for (k in data) {
          ...
          html = buildUserHTML(amazonPath, v['id'], v['name']);
          list.append(html);
          add = $('.add' + v['id']);
          _results1.push(add.click(followHandler));
        }
        return _results1;
      }
    };
    ...
    $('a#deleteTmp').on('click', function(event) {});
    return $('#search').on('keypress', function(event) {
      var entries, entry, keycode, list, pageLimit, searchValue, type, url, _i, _len;
      keycode = event.keyCode;
      if (window.location.pathname === "/users/following") {
        type = "users";
      ...
      if (keycode === 13 && type === 'entries') {
        ...
        console.log("3gh3a35gm2x9x3as2qp69rr4");
