...
ActiveRecord::Schema.define(version: 20150129163909) do
  ...
  add_index "zaps", ["entry_id"], name: "index_zaps_on_entry_id", using: :btree
  add_index "zaps", ["user_id"], name: "index_zaps_on_user_id", using: :btree
